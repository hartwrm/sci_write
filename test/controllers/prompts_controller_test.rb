...
class PromptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prompt" do
    assert_difference('Prompt.count') do
      post prompts_url, params: { prompt: { writing_prompt: @prompt.writing_prompt } }, as: :json
    end
  ...
  test "should update prompt" do
    patch prompt_url(@prompt), params: { prompt: { writing_prompt: @prompt.writing_prompt } }, as: :json
    assert_response 200
  end
